...
This is a modification of ZeroBrane Studio made to facilitate its use for programming Lua
Events for Civilization II: Test of Time with the [Test of Time Patch Project](https://forums.civfanatics.com/threads/the-test-of-time-patch-project.517282/).
A list of changed files can be found at the end of this readme.  The original readme for the ZeroBrane project follows (except for the last section).
