...
function plugin.onProjectLoad(self,project)
    ...
    if found then
      ...
      ide:Print("Loaded autocomplete and highlighting from "..project.."Scripts"..separator.."totpp-api")
    else
      ...
      ide:Print("Loaded generic TOTPP autocomplete and highlighting.")
    end
end
