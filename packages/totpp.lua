...
local defaultKeyWordList = {}
defaultKeyWordList[1] = "civ.ui.centerView civlua.findCapital civ.isLeader civ.getTribe civ.isBaseTerrain civ.getToTDir civ.enableTechGroup civ.getUnit civ.ui.text civ.makeAggression civ.takeTech civ.hasImprovement civ.removeImprovement civ.scen.onTurn civ.getCurrentTile civ.scen.onBribeUnit civ.getUnitType civ.getOpenCity civ.isTradeRoute civ.scen.onLoad civ.scen.onInitiateCombat civ.scen.onGameEnds civ.getCity civ.isDialog civ.scen.onCityDestroyed civ.scen.onCalculateCityYield civ.scen.onCityFounded civ.scen.onCanBuild civlua.iterateTribes civ.scen.onUseNuclearWeapon civ.addImprovement civ.isCity civ.iterateCities civ.deleteCity civ.ui.loadImage civ.isTribe civ.scen.onGetFormattedDate civ.scen.onTribeTurnBegin civlua.serialize civ.getMapDimensions civlua.justOnce civ.createUnit civlua.iterateTiles civ.createCity civ.getPlayerTribe civ.hasTech civ.ui.redrawMap civ.getAtlasDimensions civ.destroyWonder civlua.createUnit civ.scen.onResolveCombat civ.captureCity civlua.findUnitType civ.deleteUnit civ.getMap civlua.property civ.getImprovement civ.ui.loadTerrain civlua.unserialize civ.scen.onUnitKilled civ.getWonder civ.giveTech civ.isUnit civ.isImprovement civ.playVideo civ.getGameYear civ.isTech civ.getCurrentTribe civ.isTerrain civ.ui.setZoom civ.playMusic civlua.findCity civ.scen.onChooseDefender civ.getTerrain civ.sleep civ.ui.createDialog civlua.findTribe civ.scen.onNegotiation civ.scen.onSave civ.isUnitType civ.scen.onCityProcessingComplete civ.ui.redrawTile civ.scen.onKeyPress civ.scen.onGetRushBuyCost cantSell civ.ui.zoomIn civ.canEnter civ.getActiveUnit civ.playSound civ.getTurn civ.isMap civ.scen.onSelectMusic civ.scen.onCityProduction civ.getTile civ.scen.onCanFoundCity civ.endGame civ.teleportUnit civ.getCommodity civ.isWonder civ.ui.zoomOut civ.isImage civ.killTribe civ.scen.onScenarioLoaded civ.getTech civ.scen.onCityTaken civ.getBaseTerrain civ.scen.onTribeTurnEnd civ.scen.onActivateUnit civlua.isValidUnitLocation civ.isTile civ.scen.onSchism civ.iterateUnits civ.scen.onCentauriArrival "

defaultKeyWordList[2] = "totpp.patches.DirectShowVideo totpp.patches.CustomModResources river civ.cosmic.scoreCitizen totpp.patches.AcivateUnitScrollbar civlua.terrain.plains totpp.patches.Mutex civlua.domain.sea researching gotoTile getBaseTerrain civ.cosmic.helisPickupHuts kill color totpp.patches.TerrainOverlays hold enableTechGroup totpp.patches.Movedebug totpp.patches.CustomResources workers civ.scen.params.decisiveDefeat attackSpent civ.cosmic.numberOfUnitTypes civlua.terrain.glacier civilize totpp.patches.CityWinUnitSelect spaceship move irrigateTo totpp.patches.Cosmic irrigateAI size totpp.patches.LuaScripting civ.scen.params.marginalVictory carriedBy totpp.patches.GlobalWarming civ.scen.params.decisiveVictory totpp.patches.Throneroom terrainType totpp.patches.MajorObjective totpp.patches.RoadTrade prereq1 numUnhappy mineBonus customResources civlua.terrain.swamp civ.cosmic.foodRows irrigateBonus science location totpp.movementMultipliers.river totpp.patches.NavigableRivers flags civ.game.humanPlayers totpp.patches.NativeTransport specialists civ.game.turnsElapsed defense civ.cosmic.sizeSewer totpp.patches.AttacksPerTurn totpp.patches.ResetCityName role totpp.patches.EditTerrainKeys totpp.patches.ResourceAnimationLoop currentProduction city canEnter activate civ.game.activeTribes height civ.cosmic.penaltyBetrayal totpp.patches.TradeRevenue damage adjective totpp.patches.BuildTransporter researchCost totpp.patches.SaveExt teleport civ.cosmic.supportCommunism visibility totpp.patches.NoStackKills totpp.patches.LWSettings civ.cosmic.transformBase totpp.patches.ShieldColors civ.game.barbarianActivity hasGoodieHut hasImprovement civ.scen.params.startingYear totpp.patches.ImpassableAir totpp.patches.RushBuy mineAI cost totpp.patches.TransformCheck totpp.patches.Mods attack removeImprovement civlua.terrain.desert order totpp.patches.MoveUnitEvent civ.game.humanTribe aiValue totpp.patches.Techs getTerrain relocate mineTurns totpp.patches.Difficulty civ.scen.params.name totpp.patches.ZoomLevel turnsSinceCapture civ.scen.params.yearIncrement hitpoints mineTo civ.game.peaceTurns prereq2 civ.cosmic.prodChangePenalty totpp.roadTrade totpp.patches.EventHeap active useTransport copyDefaultResources owner civ.scen.compatibility.activateUnitEveryMove civ.cosmic.goodieHutsMask civ.cosmic.scoreWonder group grasslandShield numTradeRoutes addImprovement civ.cosmic.triremeLost civ.cosmic.massThrustParadigm civ.cosmic.scienceLostFundamentalism landmass totpp.patches.CityPopulationLoss totpp.patches.Units expires sizeForTribe y x civ.cosmic.supportMonarchy z totpp.patches.CityUnitLimits civ.scen.params.techParadigm notAllowedOnMap totpp.patches.TOTPPConfig knownTo civ.cosmic.sizeAquaduct totpp.patches.NoCD totpp.patches.ImprovementFlags researched civ.cosmic.foodEaten civlua.terrain.tundra totpp.patches.DebugScripts firepower totalShield totpp.patches.ShipDisband category visibleImprovements irrigateTurns civ.cosmic.shieldRows totpp.patches.PikemenFlag leader totpp.patches.NoLimits scienceRate totpp.patches.AITweaks totalTrade veteran treaties betrayals totpp.patches.LuaScenario attitude totpp.patches.UnitIndicators totpp.patches.FixHostility civlua.terrain.mountains totpp.patches.Landmarks range fertility civ.scen.params.maxTurns coastal totpp.patches.DefenseBonus civlua.domain.air totpp.patches.DiplomacyScreenCrash advancedFlags civ.cosmic.scoreCentauri totpp.patches.TerrainTypes cityStyle giveTech totalFood totpp.patches.DirectShowAudio abbrev isHuman researchProgress civ.game.revealMap domain impassable totpp.patches.Overview totpp.patches.TakeTechnology totpp.patches.CitySprites improvements civlua.terrain.jungle baseTrade numTechs name civ.cosmic.scorePeace civlua.terrain.hills reputation taxRate homeCity civlua.terrain.grassland baseTerrain civlua.domain.ground moveCost originalOwner civ.cosmic.techParadigm totpp.movementMultipliers.railroad transformTo canIrrigate domainSpec civlua.terrain.forest civ.cosmic.riotFactor civ.cosmic.sizeUnhappiness totpp.patches.StealTech destroy id civ.scen.params.marginalDefeat civ.cosmic.scorePollution civ.cosmic.scoreFutureTech civ.cosmic.scoreUnitKilled minimumBribe civ.cosmic.scienceRateFundamentalism civ.cosmic.paradropRange numUnits tax civ.cosmic.settlersEatHigh prereq civ.cosmic.supportFundamentalism civ.cosmic.roadMultiplier totpp.patches.ProductionCarryOver type totpp.patches.FixEditControl trade numCities totpp.patches.MapLayout units canMine expand civ.cosmic.settlersEatLow civ.scen.params.objectivesProtagonist addTradeRoute civ.scen.params.flags totpp.patches.ModifyReputation totpp.patches.CityWinUnitDisband totpp.patches.Playable popTradeRoute government totpp.patches.DirectShowMusic totpp.patches.MouseWheel moveSpent civ.game.gameYear modifier removeTradeRoute epoch destroyed food totpp.patches.Reporting female tribeMayBuild width resource futureTechs civ.game.rules.flatWorld canBuild numHappy totpp.patches.CityView map totpp.patches.SettlerFlags patience nativeTransport takeTech totpp.patches.TransformTech onCapture totpp.patches.CityWorkingTiles totpp.patches.DecreaseCPUUse totpp.mod.premadeMap attributes totpp.patches.MovementRate totpp.movementMultipliers.alpine totpp.patches.ImprovementIcons totpp.patches.UnitOrientation tradeRoutes civ.cosmic.communismPalaceDistance totpp.patches.CombatAnimation money totpp.patches.EndPlayerTurn totpp.patches.RRMultiplier totpp.patches.TeleporterMapCheck upkeep totpp.patches.DisabledButton civ.game.difficulty terrain hasTech totpp.patches.CivilopediaWonderGraphics buildTransport totpp.movementMultipliers.road defender totpp.movementMultipliers.aggregate attacksPerTurn totpp.patches.Fertility civlua.terrain.ocean shields totpp.patches.HealthBars "
...
-- 4. Adding civlua Items
-- 5. Adding automatically generated API elements
--    (The raw text will preceed these additions)
-- 6. Returning the API
...
--    4.  civlua module 
documentation.civlua = {
    type = "lib",
    description = "Test of Time Patch Project functionality provided by TheNamelessOne with the TOTPP and written in Lua.",
    childs = {},
}

documentation.civlua.childs.domain = {
    type = "lib",
    description = "Provides the three integers representing unit type domains (ground, air sea).",
    childs = {
        ground = { type = "value", valuetype = "integer", returns = "(integer)", description = "The domain value for ground units (0)."},
        air = { type = "value", valuetype = "integer", returns = "(integer)", description = "The domain value for air units (1)."},
        sea = { type = "value", valuetype = "integer", returns = "(integer)", description = "The domain value for sea units (2)."},
    },
}
documentation.civlua.childs.terrain = {
    type = "lib",
    description = "Provides integers representing the different terrain types in the base game.",
    childs = {
        desert = {type = "value", valuetype = "integer", returns = "(integer)",
            description = "The terrain value for desert (0).",},
        plains = {type = "value", valuetype = "integer", returns = "(integer)",
            description = "The terrain value for plains (1).",},
        grassland = {type = "value", valuetype = "integer", returns = "(integer)",
            description = "The terrain value for grassland (2).",},
        forest = {type = "value", valuetype = "integer", returns = "(integer)",
            description = "The terrain value for forest (3).",},
        hills = {type = "value", valuetype = "integer", returns = "(integer)",
            description = "The terrain value for hills (4).",},
        mountains = {type = "value", valuetype = "integer", returns = "(integer)",
            description = "The terrain value for mountains (5).",},
        tundra = {type = "value", valuetype = "integer", returns = "(integer)",
            description = "The terrain value for tundra (6).",},
        glacier = {type = "value", valuetype = "integer", returns = "(integer)",
            description = "The terrain value for glacier (7).",},
        swamp = {type = "value", valuetype = "integer", returns = "(integer)",
            description = "The terrain value for swamp (8).",},
        jungle = {type = "value", valuetype = "integer", returns = "(integer)",
            description = "The terrain value for jungle (9).",},
        ocean = {type = "value", valuetype = "integer", returns = "(integer)",
            description = "The terrain value for ocean (10).",},
    },
}

documentation.civlua.childs.property = {
    type = "function", returns = "(table of functions)", description = [[Wraps getting and setting of key `n` in table `t`.
local function property(t, n)
  return {get = function () return t[n] end,
          set = function (v) t[n] = v end}
end]], args="(t: table, n: key)",
}
documentation.civlua.childs.justOnce = {
    type = "function", returns = "(void)", valuetype = "void", args = "(guard, f:function)", description = 
    [[When property `guard` is false, runs `f` and sets `guard` to true, otherwise does nothing. 
Note: recommend using gen.justOnce instead
Usage:
local state = {}
...
documentation.civlua.childs.iterateTiles = {
    type = "function", returns = "(iterator)", valuetype = "iterator", args = "()",
    description = "Returns an iterator yielding all tiles on all maps.",
}

documentation.civlua.childs.iterateTribes = {
    type = "function", returns = "(iterator)", valuetype = "iterator", args = "()",
    description = "Returns an iterator yielding all tribes.",
}

documentation.civlua.childs.findUnitType = {
    type = "function", returns = "(unitTypeObject)", valuetype = "unitTypeObject", args = "(name: string)",
    description = "Finds a unit type object with the given name.",
}

documentation.civlua.childs.findCity = {
    type = "function", returns = "(cityObject)", valuetype = "cityObject", args = "(name: string)",
    description = "Finds a city object with the given name.",
}
documentation.civlua.childs.findTribe = {
    type = "function", returns = "(tribeObject)", valuetype = "tribeObject", args = "(name: string)",
    description = "Finds a tribe object with the given name.",
}

documentation.civlua.childs.findCapital = {
    type = "function", returns = "(cityObject)", valuetype = "cityObject", args = "(tribe: tribeObject)",
    description = "Finds a capital city (i.e. city with a Palace) for the given tribe.",
}

documentation.civlua.childs.isValidUnitLocation = {
    type = "function", returns = "(boolean)", valuetype = "boolean", args = "(unitType, tribe, tile)",
    description = "Returns true if `tile` is a valid location for a unit of type `unittype`, with owner `tribe`, false otherwise.",
}
documentation.civlua.childs.createUnit = {
    type = "function", returns = "(table of units)",  args = "(unittype, tribe, locations: table, options: table)",
    description = [[Create (a) unit(s) of type `unittype`, owned by tribe `tribe`. This is the Lua implementation of the CreateUnit action.
...
documentation.civlua.childs.serialize = {
    type = "function", returns="(string)", valuetype = "string", args = "(o: object)", description = "Return a string representation of object `o`.",
}
documentation.civlua.childs.unserialize = {
    type = "function", returns="(object)",  args = "(buffer: string)", description = "Return a lua object from string `buffer`",
}

--    5.  Automatically Generated API elements
--    Raw Text
--[[
aggregate (get)
...
documentation["improvementObject"]["childs"]["cantSell"] = { type = [[value]], description = "(get/set - ephemeral)\nimprovement.cantSell -> boolean\n\nReturns `true` if the improvement cannot be sold, `false` otherwise. Requires the \"Improvement flags\" patch.", valuetype = "boolean",}
...
defaultApi = {api=documentation, keyWordList = defaultKeyWordList}





-- change autocomplete.lua
...
function plugin.onProjectLoad(self,project)
    local found, totpp_api_table = pcall(require,project.."Scripts"..separator.."totpp-api")
    if found then
      local totpp_api = totpp_api_table.api
      ide:AddAPI("lua","totpp",totpp_api)
      for i=1,#totpp_api_table.keyWordList do
        luaSpec.keywords[#luaSpec.keywords +1] = totpp_api_table.keyWordList[i]
      end
    else
      ide:AddAPI("lua","totpp",defaultApi.api)
      for i=1,#defaultApi.keyWordList do
        luaSpec.keywords[#luaSpec.keywords +1] = defaultApi.keyWordList[i]
      end
    end
end

function plugin.onProjectClose(self,project)
  ide:AddAPI("lua","totpp",{})
end
